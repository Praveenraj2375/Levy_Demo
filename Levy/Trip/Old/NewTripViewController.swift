...
class NewTripViewControllerOld:NewDetailInsertionVC{
    ...
    private let selectedFriendImage = UIImage(systemName: "chevron.right")
    ...
    private func setFriendsCountLabelText(){
        var string = ""
...
extension NewTripViewControllerOld:UITableViewDataSource,UITableViewDelegate,RemoveFriendsFromSelectedFreindsDelegate{
...
extension NewTripViewControllerOld{
...
extension NewTripViewControllerOld:UpdateFriendsDelegate{
